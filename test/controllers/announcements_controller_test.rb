...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { description: @announcement.description, image: @announcement.image, showonhome: @announcement.showonhome, title: @announcement.title } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { description: @announcement.description, image: @announcement.image, showonhome: @announcement.showonhome, title: @announcement.title } }
