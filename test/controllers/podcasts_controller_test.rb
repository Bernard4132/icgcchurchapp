...
class PodcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post podcasts_url, params: { podcast: { audiotrack: @podcast.audiotrack, title: @podcast.title } }
    end
  ...
  test "should update podcast" do
    patch podcast_url(@podcast), params: { podcast: { audiotrack: @podcast.audiotrack, title: @podcast.title } }
